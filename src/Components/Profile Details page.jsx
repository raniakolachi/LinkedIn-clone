  ...
  return (
    <>
        ...
        >
          <Container className="pt-5">
            ...
            <Typography
              ...
              fontWeight="bold"
            >
              Show all posts<EastIcon className="ms-2 "></EastIcon>
            </Typography>
          </Container>
        </Card>
      </Box>
            ...
            <Box className="d-flex ">
              ...
              <Box>
                ...
                <Typography className="ms-3">
                  Completed three functional projects: a Currency Converter, a
                  Quiz App, and a Stopwatch. Utilized <br></br>features such as
                  dropdowns and hovereffects, employing
                </Typography>
              </Box>
            </Box>
      ...
      >
        ...
        >
          <Container className="pt-5">
            <Row>
              <Col md={12}>
                ...
                <Box>
                  ...
                  <Typography variant="body6">Oct 2024</Typography>
                  <br></br>
                  <Typography variant="body6">
                    Developed a fully responsive multi-page website using the
                    Bootstrap Grid system. Implemented <br></br> Add-to-Cart
                    functionality with JavaScript, showcasing expertise in{" "}
                    <br></br> creating landing pages compatible with all
                    devices.
                  </Typography>
                  <Box>
                    <Box className="d-flex">
            ...
            <Typography className="ms-3">
              Developed a fully responsive multi-page website using the
              Bootstrap Grid system—showcasing expertise <br></br>in creating
              landing pages compatible with all devices.
            </Typography>
            <Box>
              <Box className="d-flex">
                <Avatar
      ...
      >
        <Card
          style={{
            width: { xs: "90%", sm: "100%", md: "100%", lg: "80%" },
            padding: "20px",
            width: "69%",
            boxShadow: "0px 4px 10px rgba(0, 0, 0, 0.1)",
          }}
        >
          <Container className="pt-5">
            ...
            <Typography
              ...
              fontWeight="bold"
            >
              Show all 7 skills <EastIcon className="ms-2"></EastIcon>
            </Typography>
          </Container>
        </Card>
      </Box>
        ...
        >
          <Container className="pt-2">
            <Row>
              <Col md={12}>
                ...
                <Box>
                  ...
                  <Typography variant="body3">Newsletters</Typography>
                  <Divider style={{ backgroundColor: "#ccc", margin: "10px 0" }} />

                  <Box className="d-flex justify-content-between mx-5">
                    <Box className="d-flex">
                    <Box>
                      <Avatar className="me-4 mt-2"  variant="square"  src="https://media.licdn.com/dms/image/v2/C560BAQHaVYd13rRz3A/company-logo_100_100/company-logo_100_100/0/1638831590218/linkedin_logo?e=1746662400&v=beta&t=ZYvtfix2atsMrKtQJPHyXFVK2d2FvaGrB0emGSjOCgo" ></Avatar>
                    </Box>
                    <Box>
                      <Typography variant="h6" >LinkedIn</Typography>
                      <Typography varient="body3" >29,834,445 followers</Typography>
                      <Button className="mt-3 rounded-4 bg-white text-black" ><DownloadDoneIcon></DownloadDoneIcon>  Following</Button>
                    </Box>
                    </Box>
                    <Box className="d-flex">
                    <Box>
                      <Avatar className="me-4 mt-2"  variant="square"  src="https://media.licdn.com/dms/image/v2/C4E0BAQFyLTndQ0dnpw/company-logo_100_100/company-logo_100_100/0/1630626717359/linkedin_news_asia_logo?e=1746662400&v=beta&t=50mM2xL1uyE-YhHOCIgnXL_k0Tew_oOmknBMiV1KZNw" ></Avatar>
                    </Box>
                    <Box>
                      <Typography variant="h6" >LinkedIn News Asia</Typography>
                      <Typography varient="body3" >5,782,883 followers</Typography>
                      <Button className="mt-3 rounded-4 bg-white text-black" ><DownloadDoneIcon></DownloadDoneIcon>  Following</Button>
                    </Box>
                    </Box>
                  </Box>
            ...
            <Typography
              ...
              fontWeight="bold"
            >
              Show all companies <EastIcon className="ms-2"></EastIcon>
            </Typography>
          </Container>
        </Card>
      </Box>
